...
@Component({
  selector: 'app-fix-vpnadsl-vpnll',
  templateUrl: './fix-vpnadsl-vpnll.component.html',
  styleUrls: ['./fix-vpnadsl-vpnll.component.scss']
})
export class FixVpnadslVpnllComponent implements OnInit {

  displayedColumns: string[] = [
    'numeroLigne', 'affectation', 'poste', 'etat', 'dateLivraison',
    'numeroSerie', 'montant', 'categorie', 'debit', 'adresseIp', 'ACTIONS'];

  dataSource!: MatTableDataSource<any>;
  typeLigne: string = "FIX";
...
//MatDialog   (Modal)
  openAddEditLignForm() {
    const dialogRef = this._dialog.open(LigneAddEditComponent, {
      data: {typeLigne: {value: "FixVpnAdslVpnLL", viewValue: "Fix / VpnAdsl / VpnLL"}}
    });
