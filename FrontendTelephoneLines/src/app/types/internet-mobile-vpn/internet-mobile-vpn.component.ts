...
@Component({
  selector: 'app-internet-mobile-vpn',
  templateUrl: './internet-mobile-vpn.component.html',
  styleUrls: ['./internet-mobile-vpn.component.scss']
})
export class InternetMobileVPNComponent implements OnInit{

  displayedColumns: string[] = [
    'numeroLigne', 'affectation', 'poste', 'etat', 'dateLivraison',
    'numeroSerie', 'montant', 'ACTIONS'];

  dataSource!: MatTableDataSource<any>;
  typeLigne: string = "IMV";
...
//MatDialog   (Modal)
  openAddEditLignForm() {
    const dialogRef = this._dialog.open(LigneAddEditComponent, {
      data: {typeLigne: {value: "InternetMobileVPN", viewValue: "Internet-Mobile-VPN"}}
    });
