...
@Component({
  selector: 'app-internet-mobile',
  templateUrl: './internet-mobile.component.html',
  styleUrls: ['./internet-mobile.component.scss']
})
export class InternetMobileComponent implements OnInit {

  displayedColumns: string[] = [
    'numeroLigne', 'affectation', 'poste', 'etat', 'dateLivraison',
    'numeroSerie', 'montant', 'fonction', 'forfait', 'codePIN', 'codePUK', 'ACTIONS'];
...
//MatDialog   (Modal)
  openAddEditLignForm() {
    const dialogRef = this._dialog.open(LigneAddEditComponent, {
      data: {typeLigne: {value: "InternetMobile", viewValue: "Internet-Mobile"}}
    });
